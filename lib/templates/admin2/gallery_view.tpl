<div class="gallery_view">
    <div>
        <form class="form" action="/admin2/image/?create=1" method="post" enctype="multipart/form-data" autocomplete=off>
    ...
    <div>
        <table class="edit" cellspacing="0" cellpadding="3">
            ...
            <tbody>
                ...
                {% for img in imgs %}
                <tr>
            <form name="image_edit" id="image_edit" action="/admin2/image/" method="post">
                <input type="hidden" name="gallery" value="{{gal.key}}"/>
